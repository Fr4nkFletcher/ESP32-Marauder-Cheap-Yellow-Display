...
class AsyncWebServerRequest {
  ...
  private:
    ...
    LinkedListESPAsync<AsyncWebHeader *> _headers;
    LinkedListESPAsync<AsyncWebParameter *> _params;
    LinkedListESPAsync<String *> _pathParams;
...
class AsyncWebServer {
  protected:
    AsyncServer _server;
    LinkedListESPAsync<AsyncWebRewrite*> _rewrites;
    LinkedListESPAsync<AsyncWebHandler*> _handlers;
...
class DefaultHeaders {
  using headers_t = LinkedListESPAsync<AsyncWebHeader *>;
  headers_t _headers;
